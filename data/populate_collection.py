...
initialize_collection('services_collection', 'services_with_embeddings.json', path=chroma_db_path)
initialize_collection('bedrock_faqs_collection', 'bedrock_faqs_with_embeddings.json', path=chroma_db_path)
